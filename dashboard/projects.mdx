...
This means you can safely use one project for production and another for testing without any risk of interference. Wallet balances are tracked per customer in integer credits (1 credit = 1 micro-USD, so 1 USD = 1,000,000 credits), so funds are always unambiguous across projects.
